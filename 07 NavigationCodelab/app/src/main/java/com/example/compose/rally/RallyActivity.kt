...
fun RallyApp() {
    RallyTheme {
        ...
        val currentDestination = currentBackStack?.destination // used to get current destination
        val currentScreen =
            rallyTabRowScreens.find { it.route == currentDestination?.route } ?: Overview
        // rallyTabRowScreens contains the list of destinations and the route variable is a string
        Scaffold(
            topBar = {
                RallyTabRow(
...
fun NavHostController.navigateToSingleAccount(accountType: String) {
    ...
    //here, accountType is the parameter to be passed
}
